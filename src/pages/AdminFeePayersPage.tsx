      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Add New Fee Payer</DialogTitle>
                <DialogDescription>
                  Add a new Solana wallet to be used for paying transaction fees.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <div className="bg-muted p-3 rounded-md text-sm text-muted-foreground">
                  ...
                  Note: The private key for this wallet must be configured in your backend secrets for it to be usable.
                </div>
              </div>
              <DialogFooter>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                No fee payers configured. Add one to get started.
              </div>
            ) : (
              <Table>
                <TableHeader>
