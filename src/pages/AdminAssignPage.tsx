...
import { Search, Coins, UserPlus } from 'lucide-react';
...
export default function AdminAssignPage() {
  ...
  return (
    <DashboardLayout
      title="Assign Tokens"
      subtitle="Distribute tokens to users"
      requireAdmin
    >
      <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
        <div className="glass-card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg font-semibold text-foreground">Token Assignment</h2>
              <p className="text-sm text-muted-foreground">
                Assign token balances to users
              </p>
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Create token definitions for assets first.
              </p>
            </div>
          ) : (
                ...
                <div className="bg-muted/30 rounded-lg p-4 border border-border">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="badge-gold text-xs">
                      {TOKEN_MODEL_LABELS[selectedToken.token_model]}
                    </span>
                  </div>
                  <div className="mt-3 grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-foreground">
                        {Number(selectedToken.total_supply).toLocaleString()}
                      </p>
                    </div>
                  </div>
                </div>
