...
import { LayoutDashboard, Coins, User, Users, Activity, LogOut, Award, Vote, ArrowRightLeft, FileCheck, Wallet, Globe, FileUp, FolderOpen, ClipboardList, Archive, Zap, ShieldCheck, Bot, Newspaper, FileText, Package, Rocket, Sparkles, BarChart3, FileSignature, Layers, Radar, MonitorDot, Crosshair } from "lucide-react";
...
const adminNavigation = [{
  ...
  name: "Fee Payers (SOL)",
  href: "/admin/fee-payers",
  icon: Wallet
}, {
  name: "Fee Payers (EVM)",
  href: "/admin/evm-fee-payers",
  icon: Globe
}, {
  name: "Arbitrage",
  href: "/admin/arbitrage/strategies",
  icon: Zap
}, {
  name: "Auto Arbitrage",
  href: "/admin/arbitrage/automation",
  icon: Bot
}, {
  ...
  name: "Profit Discovery",
  href: "/admin/arbitrage/profit-discovery",
  icon: Crosshair
}, {
  name: "News",
  href: "/admin/news",
...
export function Sidebar() {
  ...
  return <div className="flex h-full w-64 flex-col bg-sidebar border-r border-sidebar-border">
      ...
      <div className="border-t border-sidebar-border p-4">
        ...
        <button onClick={signOut} className="sidebar-link w-full text-destructive hover:bg-destructive/10 hover:text-destructive">
